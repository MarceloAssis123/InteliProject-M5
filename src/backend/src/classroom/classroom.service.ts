...
export class ClassroomService {
	...
	*/
	...
	/**
	 * Registra uma aula para uma turma específica.
	 * 
	 * @param {Date} date - A data e hora da aula.
	 * @param {number} classroomid - O ID da turma.
	 * 
	 * @returns {Promise<any>} Uma promessa que resolve para o ID da aula recém-registrada.
	 */
	 ...
	 * 
	 * @param {number} classid - O ID da aula.
	 * @param {number} studentid - O ID do aluno.
	 * @param {boolean} presence - A presença do aluno.
	 * 
	 * @returns {Promise<any>} Uma promessa que resolve para o ID do aluno e a presença registrada.
	 */
