...
export class WorkshopService {
    ...
    */
    ...
    /**
     * Lista todos os alunos associados a uma ONG específica, baseando-se no ID da ONG fornecido como parâmetro.
     * Retorna uma lista de alunos, incluindo informações como o nome do aluno, o gênero, a data de nascimento, o endereço,
     * o estado civil, a etnia, a cidade, o estado, o número de telefone, o número de telefone fixo, o email, o RG e o CPF.
     * 
     * @param {number} idOng - O ID da ONG cujos alunos serão listados.
     * 
     * @returns {Promise<Student[]>} Uma promessa que resolve para uma lista de entidades `Student`,
     */
    ...
    /**
     * Realiza uma contagem de todos os alunos associados a uma oficina específica, baseando-se no ID da oficina fornecido.
     * 
     * @param {number} idWorkshop - O ID da oficina para a qual a contagem de alunos será realizada.
     * 
     * @returns {Promise<number>} Uma promessa que resolve para o número total de alunos associados à oficina especificada.
     */
     ...
     * 
     * @param {number} idWorkshop - O ID da oficina para a qual as presenças serão listadas.
     * 
     * @returns {Promise<Array>} Uma promessa que resolve para uma lista contendo todas as presenças do aluno na turma.
     */
     ...
     * 
     * @param {number} idWorkshop - O ID da oficina para a qual as turmas serão listadas.
     * 
  ...
  /**
   * Realiza a criação de uma nova oficina no sistema. Este método recebe os dados de uma nova oficina
   * através do corpo da requisição e utiliza o `WorkshopService` para registrar a oficina no sistema.
   * Os dados da oficina são fornecidos como um objeto `WorkshopDTO`, que inclui todas as informações
   * necessárias para o cadastro de uma nova oficina.
   * 
   * @param {string} name - O nome da oficina.
   * @param {number} ongId - O ID da ONG responsável pela oficina.
   * @param {number} categoryId - O ID da categoria da oficina.
   * @param {string} description - A descrição da oficina.
   * 
  ...
  /**
   * Lista a oficina de acordo com o ID fornecido.
   * 
   * @param {number} id - O ID da oficina a ser listada.
   * 
   * @returns {Promise<Workshop>} Uma promessa que resolve para a entidade `Workshop` da oficina.
   */
