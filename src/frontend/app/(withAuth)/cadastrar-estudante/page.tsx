	...
	if (loading) {
		return (
			<>
				...
				<IntialStructureForm title='Preencha as informações abaixo para cadastrar um(a) novo(a) aluno(a)!'>
					<FormStudentRegister entity='aluno' url='students' messageApi={messageApi}/>
				</IntialStructureForm>
			</>
