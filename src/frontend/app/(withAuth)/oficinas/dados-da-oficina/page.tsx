...
export default function WorkshopDetailsPage() {
	// Hook para obter o id da oficina
	const [id, setId] = useState<string>('');

	// Função para obter o id da oficina
	useEffect(() => {
	...
	// Armazenamento do estado do nome da oficina e das turmas
	const [nameWorkshop, setNameWorkshop] = useState('');
	const [classrooms, setClassrooms] = useState<any[]>([]);

	// Função para obter os dados da oficina
	useEffect(() => {
	...
	// Função para obter as turmas da oficina e os dados de presença
	useEffect(() => {
	...
	// Função para obter os dados de presença da oficina
	useEffect(() => {
	...
	// Função para renderizar o gráfico de presença
	useEffect(() => {
		if (chartRef.current) {
