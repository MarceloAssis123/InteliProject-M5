...
import { Checkbox, Modal, Avatar, Button, Form, Input, Select, message } from 'antd';
...
// Este componente é responsável por renderizar a página de professores
export default function Professors() {
    ...
    return (
        <>
            ...
            <InfoModal messageApi={messageApi} getWorkshops={getWorkshops} selectedProfessorId={selectedProfessorId} data={data} setProfessors={setProfessors} setIsModalVisible={setIsModalVisible} isModalVisible={isModalVisible} />
        </>
    );
}