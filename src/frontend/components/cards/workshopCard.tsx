...
export default function WorkshopCard({ workshopname, classroomname, color, studentsQuantity, weekDay, time, workshopId, showSchedule, showParticipants, showClassroomName, link, showWorkshopPage }: workshopProps) {
            ...
            {session?.user.role === 'Leader' && (
                <IconContainer>
                    <ContainerInfosCard>
                        ...
                        {showWorkshopPage && (
                            <StyledLink href={`/oficinas/aula/?id=${workshopId}`}>
                                <Icon>
                                    <BarChartOutlined />
                                </Icon>
                                Visualizar oficina
