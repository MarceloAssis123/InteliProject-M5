...
// Este componente é a página de oficinas do professor, onde ele pode visualizar as oficinas que ele ministra
				...
				<Main>
					...
					<CardsDiv>
						{workshops?.
							...
							.map((workshop: any) => {
								const studentsQuantity = workshop?.classroom[0]?.students ? workshop?.classroom[0]?.students.length : 0
								return <WorkshopCard
